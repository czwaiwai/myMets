           ...
           <ul class="table_line">
            <li v-for="(item,index) in list" :key="index">
              <div @click="showDetail(index)" class="weui-flex table_item">
                <div class="col " style="width:1.8rem;">{{item.rightnumber}}</div>
                <div class="col weui-flex__item">{{item.name}}</div>
                <div class="col " style="width: 1.8rem;">{{item.warrantstateName}}</div>
