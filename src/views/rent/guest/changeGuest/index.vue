<template>
  <div class="page page_bg">
    <nav-title title="修改信息"></nav-title>
    <div class="page_bd changeGuest">
      <div class="content">
        <div class="baseMsg">
...
export default {
  ...
  methods: {
    ...
    async submit () {
      ...
      // }
      // let res = await this.$http.post(obj)
      let res = await this.$xml('UserAppCst_Update', {
        'ID': this.$route.params.id,
        'OrgID': this.locationData.orgData.orgId,
        'CstType': this.cstType.value,
        'Name': this.name,
    ...
    init () {
      this.name = this.guestDetail.CstName
      this.person = this.guestDetail.LinkMan
      this.phone = this.guestDetail.FirstPhone
      ...
      if (this.guestDetail.CstType) {
        this.cstType = {
          hasSelect: true,
          value: this.guestDetail.CstType,
          showText: this.com_type(this.guestDetail.CstType)
        }
      }
      if (this.guestDetail.Category) {
        this.cstCategory = {
          hasSelect: true,
          value: this.guestDetail.Category,
          showText: this.guestDetail.CategoryName
        }
      }
      if (this.guestDetail.CstLevel) {
        this.cstLevel = {
          hasSelect: true,
          value: this.guestDetail.CstLevel,
          showText: this.guestDetail.CstLevelName
        }
      }
      if (this.guestDetail.CognitiveWay) {
        this.cognitiveWay = {
          hasSelect: true,
