  ...
  <div>
    <div class="theme" v-if="detailData.BookStatus==='HB'">
      <div class="inputItem clearfix">
        ...
        <input class="inputs" type="text" @input="inputText" :value="detailData.MeetName" placeholder="请输入会议主题">
      </div>
      ...
      <div class="inputItem clearfix noneBb">
        ...
        <input class="inputs" type="text" @input="inputInt" placeholder="请输入电话" :value="detailData.BookPhone">
      </div>
    </div>
