<template>
  <div class="page_modal">
    <div class="page">
      ...
      <div class="page_sub_hd " style="overflow-x:auto;height:44px;line-height:26px;">
        <p class="padding-left15" style="line-height:44px;" v-if="chooseList.length===0">暂未选择员工</p>
        <ul class="choose_person_list" style="padding: 9px 15px 9px 15px;" v-else>
